    ...
    <main>
        ...
        <div className="container mx-auto px-4 py-20 grid md:grid-cols-2 items-center gap-12">
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap gap-3">
              ...
              <a
                href="https://wa.me/919876543210?text=Hi%2C%20I%E2%80%99m%20interested%20in%20plants%20from%20Mourya%20Green%20World!"
                target="_blank"
      ...
      <section className="py-12 bg-gradient-to-r from-primary to-secondary">
        <div className="container mx-auto px-4 text-center">
          ...
          <a
            href="https://wa.me/919876543210?text=Hi%2C%20I%20need%20help%20choosing%20a%20plant!"
            target="_blank"
            rel="noopener noreferrer"
